 ...
 * Generated for Laravel 7.14.1 on 2020-06-11 23:38:54.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Request {
        ...
        {
                        return \Illuminate\Http\Request::transformEnums($transformations);
        }
...
namespace App\Models\Url\Manager { 
    ...
    class UrlShortenerFacade {
        ...
        public static function shorten($plainUrl)
        {
                        ...
                        return $instance->shorten($plainUrl);
        }
         ...
         * @static 
         */ 
        public static function load($shortenedUrl)
        {
                        /** @var \App\Models\Url\Manager\UrlManager $instance */
                        return $instance->load($shortenedUrl);
        }
         ...
         * @static 
         */ 
        public static function cacheKeyForShortenedUrl($shortened)
        {
                        /** @var \App\Models\Url\Manager\UrlManager $instance */
         ...
         *
         * @param $shortened
         * @return \App\Models\Url\Manager\Stat | null
         * @static 
         */ 
        public static function getStatForShortenedUrl($shortened)
        {
                        /** @var \App\Models\Url\Manager\UrlManager $instance */
                        return $instance->getStatForShortenedUrl($shortened);
        }
...
namespace  { 
    ...
    class Shortener extends \App\Models\Url\Manager\UrlShortenerFacade {}
